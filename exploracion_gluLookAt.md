...
## Exploración de Cámara con gluLookAt
...
### Actividad 1: Cambio de Posición (Eye):

```python
    # Configuración de la cámara
    gluLookAt(12, 1, 12,  # Posición de la cámara
              0, 0, 0,    # Punto al que mira
              0, 1 ,0 )    # Vector hacia arriba
```
...
### Actividad 3: Cambio de Orientación (Up):
